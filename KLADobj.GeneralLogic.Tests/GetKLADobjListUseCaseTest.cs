    ...
    public class GetKLADobjListUseCaseTest
    {
        private InMemoryKLADobjRepository CreateKLADobjRepository()
        {
            var repo = new InMemoryKLADobjRepository(new List<kladobj> {
                new kladobj { Id = 1, Free = "действует", Name = "Стационарный общественный туалет № 123"},
                new kladobj { Id = 2, Free = "действует", Name = "Стационарный общественный туалет № 45"},
                new kladobj { Id = 3, Free = "действует", Name = "Стационарный общественный туалет № 13"},
                new kladobj { Id = 4, Free = "действует", Name = "Стационарный общественный туалет № 85"},
            });
            return repo;
        }
        [Fact]
